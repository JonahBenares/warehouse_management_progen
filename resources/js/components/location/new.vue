...
onMounted(async () => {
	...
	const locationform = async () => {
		let response = await axios.get("/api/create_location");
	...
	axios.post("/api/add_location",formData).then(function () {
		success.value='You have successfully added new location!'
