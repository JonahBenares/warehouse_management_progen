<script setup>
	...
	const uomForm = async () => {
		let response = await axios.get("/api/create_uom");
	...
	const onSave = () => {
		...
		axios.post("/api/add_uom",formData).then(function () {
					...
					<div class="pt-1">	
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb adminx-page-breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Add New UOM</li>
							</ol>
						</nav>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group">
									...
									<input type="text" class="form-control border" v-model="form.unit_name">
								</div>									
							</div>
						</div>
