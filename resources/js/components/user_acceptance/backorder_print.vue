			...
			<div class="card mb-3" id="print_card">	
				<div class="flex justify-between content-center">
					<div class="flex justify-start space-x-3 ">
						...
						<div>
							<h6 class="m-0 pt-1 font-bold uppercase">Backorder User Acceptance</h6>
						</div>
					</div>	
					<div class="pt-1">	
							...
							<div class="z-10">
								...
								<table class="w-full table-borsdered">
									...
									<tr>
										...
										<td class="leading-tight text-sm"><span class="pr-2">:</span>{{ (head.dr_no!=null) ? head.dr_no : dr_no}}</td>
									...
									<tr>
										...
										<td class="leading-tight text-sm"><span class="pr-2">:</span>{{ (head.pcf!=null) ? (head.pcf!=null) ? 'Yes' : 'No' : (pcf!=0) ? 'Yes' : 'No' }}</td>
									</tr>
									<tr>
								...
								<div  v-for="(det, index) in details" class="border-2 p-2 border-b-0 mt-2">
									...
									<table width="100%" class="table-bordered">
										<tr>
											...
											<td class="text-xs" width="5%" align="center">Acc Qty</td>
											<td class="text-xs" width="5%" align="center">Rej Qty</td>
										...
										<tr v-for="(it, ind) in det.receive_items.items">
											<span hidden>{{ qty+=it.bo_quantity*(parseFloat(it.unit_cost) + parseFloat(it.shipping_cost)) }}</span>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="center">{{ind+1}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="center">{{it.bo_quantity}}</td>

											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 !border-2 !border-red-400 font-bold py-1 bg-red-300' : '' : 'text-xs align-top px-1 py-1'" align="center">{{it.rejected_qty}}</td>
											
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 !border-2 !border-red-400 font-bold py-1 bg-red-300' : '' : 'text-xs align-top px-1 py-1'" align="center">{{it.uom}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 !border-2 !border-red-400 font-bold py-1 bg-red-300' : '' : 'text-xs align-top px-1 py-1'" align="center">{{it.pn_no}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 !border-2 !border-red-400 font-bold py-1 bg-red-300' : '' : 'text-xs align-top px-1 py-1'" align="left">{{it.item_description}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="left">{{it.supplier_name}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="left">{{it.catalog_no}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="left">{{it.brand}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="left">{{it.color}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="left">{{it.size}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="left">{{it.item_status}}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="center">{{ it.shipping_cost }}</td>
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="center">{{it.unit_cost}} {{ (it.currency!=null) ? it.currency : '' }}</td>
											<!-- <td :class="(it.eval_flag==1) ? 'text-xs align-top px-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 bg-red-200' : ''" align="right">12</td> -->
											<td :class="(it.eval_flag!=0) ? (it.eval_flag==1) ? 'text-xs align-top px-1 py-1' : (it.eval_flag==2) ? 'text-xs align-top px-1 py-1' : '' : 'text-xs align-top px-1 py-1'" align="center">{{ (parseFloat(it.unit_cost) + parseFloat(it.shipping_cost)) *  it.bo_quantity}}</td>
										</tr>
										<tr>
