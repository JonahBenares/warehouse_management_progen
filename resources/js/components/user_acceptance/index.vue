<script setup>
	...
	const getAllReceive = async (page = 1) => {
		...
		let response = await axios.get(`/api/get_all_useracceptance?page=${page}`);
			...
			<div class="card mb-3">	
				<div class="flex justify-between content-center">
					<div class="flex justify-start space-x-3 ">
						...
						<div>
							<h6 class="m-0 pt-1 font-bold uppercase">User Acceptance <span  class="text-sm text-yellow-600">(Pending)</span></h6>
						</div>
					</div>	
					<div class="pt-1">	
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb adminx-page-breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">User Acceptance (Pending)</li>
							</ol>
						</nav>
					</div>
				</div>
