...
onMounted(async () => {
	...
	const enduseform = async () => {
		let response = await axios.get("/api/create_enduse");
	...
	axios.post("/api/add_enduse",formData).then(function () {
		success.value='You have successfully added new enduse!'
		form.value.enduse_name=''
					...
					<div class="pt-1">	
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb adminx-page-breadcrumb">
								...
								<li class="breadcrumb-item"><a href="/enduse">End-Use</a></li>
								<li class="breadcrumb-item active" aria-current="page">Add New End-Use</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-6 ">
					<div class="card">
						<div class="mt-2 mb-2 border-b">
							...
							<h6>Add New End-Use</h6>	
						</div>
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group">
									<label class="form-label mb-0">End-Use</label>
									<input type="text" class="form-control border" v-model="form.enduse_name">
								</div>										
							</div>
						</div>
