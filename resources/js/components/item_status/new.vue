...
const statusForm = async () => {
	let response = await axios.get("/api/create_status");
...
const onSave = () => {
	...
	axios.post("/api/add_status",formData).then(function () {
		error.value=''
		success.value='You have successfully added new item status!'
		form.value = []
					...
					<div class="pt-1">	
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb adminx-page-breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Add New Item Status</li>
							</ol>
						</nav>
					</div>
				</div>
