    ...
    const SaveNewGatepass = () => {
        if(confirm("Are you sure you want to save this Gatepass?")){
            ...
            formItems.append('gatepass_items', JSON.stringify(items.value))
                axios.post(`/api/save_gatepass_items_try/${props.id}`, formItems).then(function (response) {
					...
					<div class="card card-main-bg">
                                        ...
                                        <tr v-for="(i, index) in items">
                                            ...
                                            <td align="center" class="px-0">
                                                ...
                                                <div class="flex justify-center w-full">
                                                    <button class="btn btn-xs btn-rounded btn-danger text-xs p-1" @click="removeItem(index)">
						...
						<div class="pt-3 mb-2 mt-2 border-t flex justify-end space-x-10">
							<div class="flex justify-between space-x-1">
								...
								<a @click="SaveNewGatepass()" style="display:none" id = "SubmitButton" type="submit" class="btn btn-sm btn-primary  text-white w-32">Save & Print</a>
							</div>
						</div>
					</div>
				</div>
