<script setup>
	...
	const groupform = async () => {
		let response = await axios.get("/api/create_group");
	...
	const onSave = () => {
			...
			axios.post("/api/add_group",formData).then(function () {
				success.value='You have successfully added new group!'
