			...
			<div class="row" id="print_button">
				<div class="col-lg-12">
					<div class="flex justify-center mb-3 space-x-1">
						...
						<a href="#" class="btn btn-sm btn-success" @click="printDiv('printable-draft')"> Print Report</a>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="flex justify-center">
						<page size="A4" id="printable-draft" class="p-2 ">
							<!-- <img src="../../../images/bg_draft1.png" alt="" class="absolute z-10"> -->
							<div class="z-10">
								<printheader>
									MATERIAL RECEIVING & INSPECTION FORM <p class="text-xs leading-none m-0 font-bold text-green-200">DRAFT</p>
								</printheader>
								<table class="w-full table-borsdered">
									<tr>
										<td class="leading-tight text-sm font-bold" width="7%">MRF NO.</td>
								...
								<div  v-for="(det, index) in details" class="border-2 p-2 border-b-0 mt-2">
									...
									<table width="100%" class="table-bordered">
										...
										<tr>
											<td class="text-xs py-1" colspan='12' align='right'><span class="mx-1"><b>Total</b></span></td>
											<td class="text-xs bg-yellow-200 py-1" colspan='1' align='center'><b>{{ qty }}</b></td>
										</tr>
									</table>
									<table width="100%">
										<tr>
								...
								<div class="flex justify-between my-1">
									...
									<div class="mt-2 ">
										...
										<p class="text-xs leading-none m-0 text-right font-bold text-green-200">DRAFT</p>
									</div>
								</div>
							</div>
						</page>
