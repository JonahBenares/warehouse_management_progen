								...
								<div  v-for="(det, index) in details" class="border-2 p-2 border-b-0 mt-2">
									...
									<table width="100%" class="table-bordered">
										...
										<tr v-for="it in det.receive_items.items">
											...
											<td class="text-xs align-top px-1 bg-yellow-50" align="center">{{ ((parseFloat(it.unit_cost) + parseFloat(it.shipping_cost)) *  it.rec_quantity).toFixed(2)}}</td>
										</tr>
									...
									<table width="100%">
										...
										<tr>
											<td class="text-sm pt-3" >Inspected by: {{det.inspected_id}}</td>
										</tr>
									</table>
								</div>
