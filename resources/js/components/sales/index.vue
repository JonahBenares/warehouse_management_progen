								...
								<div class="flex justify-between pb-2 mt-2 mb-2">
									<div class="flex justify-between">
										<div class="input-group border rounded-xl w-80">
											...
											<input type="text" class="form-control border-0" id="search" placeholder="Type to search..." @keyup="" >
										</div>
									</div>
									<a href="/sales/new" class="btn btn-sm btn-primary btn-rounded">
								...
								<table class="table table-actions table-hover mb-0">
									...
									<tbody >
										<tr>
											...
											<td class="space-x-1">
												<a class="text-white btn btn-xs bg-yellow-500 btn-rounded">
                                                    <EyeIcon fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3"></EyeIcon>
                                                </a>
												<a  class="text-white btn btn-xs bg-blue-500 btn-rounded">
