...
class StockcardItemsExport implements FromCollection, WithMapping, ShouldAutoSize, WithHeadings, WithEvents, WithTitle, WithCustomStartCell, WithDrawings, WithStrictNullComparison
{
    /**
    ...
    */
    ...
    public function __construct($variant_id, $item, $supplier, $catalog_no, $brand, $department, $running_balance) {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) { 
                ...
                $event->sheet->getDelegate()->getStyle('L6')->applyFromArray([
                    'fill' => [
                        'fillType' => \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID,
                        'color' => ['rgb' => 'F7FFBC']
                    ]
                ...
                $event->sheet->getDelegate()->getStyle('L4:L5')->applyFromArray([
                    'fill' => [
                        'fillType' => \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID,
                        'color' => ['rgb' => '2563EB']
                    ],
                ...
                $event->sheet->getStyle('A6:L6')->getAlignment()->setHorizontal('center');
                ...
                $event->sheet->getDelegate()->getStyle('L4')->getFont()->setSize(14);
                $event->sheet->getStyle('L4')->getFont()->setBold(true);
                $event->sheet->getStyle('L4')->getAlignment()->setHorizontal('center');
                $event->sheet->getDelegate()->getStyle('L4')->getAlignment()->setVertical('center');
                $event->sheet->setCellValue('L4', 'Running Balance: '.$this->running_balance);
                ...
                $event->sheet->getDelegate()->getStyle('A4')->getAlignment()->setVertical('center');
                $event->sheet->setCellValue('A4', $this->item_name);
